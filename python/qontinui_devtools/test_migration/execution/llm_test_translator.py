...
from qontinui_devtools.core import QontinuiCore
from qontinui_devtools.state_management import State
from qontinui_devtools.actions import ActionConfig
...
"""
    ...
    def _ensure_required_imports(self, code: str, test_file: TestFile) -> str:
        ...
        if test_file.test_type == TestType.INTEGRATION:
            required_imports.extend(
                [
                    "from qontinui_devtools.config import ConfigurationManager",
                    "from qontinui_devtools.startup import QontinuiStartup",
                ]
            )
