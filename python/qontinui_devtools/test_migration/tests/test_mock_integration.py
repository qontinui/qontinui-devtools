...
from qontinui_devtools.test_migration.mocks.brobot_mock_analyzer import BrobotMockAnalyzer
...
class TestMockIntegration:
    ...
    def test_error_handling_integration(self):
        ...
        from qontinui_devtools.test_migration.core.models import GuiModel
