...
from qontinui_devtools.test_migration.core.models import GuiModel, MockUsage
from qontinui_devtools.test_migration.mocks.qontinui_mock_generator import QontinuiMockGenerator
...
class TestQontinuiMockGenerator:
    ...
    def test_generate_imports(self):
        ...
        assert "from qontinui_devtools.state_management import StateManager" in imports
        assert "from qontinui_devtools.model.element import Element" in imports
