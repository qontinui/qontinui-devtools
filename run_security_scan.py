...
REPOS = [
    ...
    ("qontinui-web/backend", "C:/Users/Joshua/Documents/qontinui_parent_directory/qontinui-web/backend"),
...
def main():
    ...
    for repo_name, repo_path in REPOS:
        ...
        if len(report.vulnerabilities) > 0:
            print()
            print(f"First 10 vulnerabilities:")
    ...
    summary_path = Path("C:/Users/Joshua/Documents/qontinui_parent_directory/.dev-logs/improve-all-security-audit.md")
            ...
            if len(report.vulnerabilities) > 0:
                ...
                for vtype, vulns in sorted(by_type.items()):
                    ...
                    for vuln in vulns[:5]:  # Show first 5 of each type
                        f.write(f"- **{vuln.severity.value}**: {vuln.file_path}:{vuln.line_number}\n")
